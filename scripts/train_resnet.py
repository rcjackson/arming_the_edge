...
checkpointer = ModelCheckpoint(
               filepath=('/homes/rjackson/arming_the_edge/models/resnet50-combined-1layer-{epoch:03d}.hdf5'),verbose=1)
early_stopping = EarlyStopping(restore_best_weights=True, patience=100,
        monitor="val_accuracy", mode="max")
history = model.fit(train_generator, validation_data=valid_generator,
        epochs=2000, callbacks=[checkpointer, early_stopping], initial_epoch=0)
